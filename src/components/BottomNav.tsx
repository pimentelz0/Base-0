...
import { Home, Dumbbell, StickyNote } from "lucide-react";
...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 bg-zinc-950/95 backdrop-blur-xl border-t border-zinc-800/80 shadow-2xl py-2 px-4 select-none"
    >
      <div className="max-w-md mx-auto flex items-center justify-around gap-2">
        ...
        <button
          ...
          className={`flex-1 flex flex-col items-center justify-center py-1.5 px-3 rounded-2xl transition-all duration-200 group relative ${
            activeTab === "home"
        ...
        >
          ...
          <span
            className={`text-[11px] font-black tracking-wider uppercase mt-1 font-['Outfit'] ${
